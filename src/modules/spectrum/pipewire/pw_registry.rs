...
use super::util::dict_to_map;
use super::util::pipewire::{
    DEFAULT_AUDIO_SINK_KEY, DEFAULT_AUDIO_SOURCE_KEY, GraphNode, derive_node_direction,
    parse_metadata_name,
};
pub use super::util::pipewire::{DefaultTarget, NodeDirection};
...
const REGISTRY_THREAD_NAME: &str = "frostbar-pw-registry";
...
impl NodeInfo {
    ...
    pub fn from_global(global: &GlobalObject<&DictRef>) -> Self {
        ...
        let is_virtual = props
            ...
            .unwrap_or_else(|| name.as_deref() == Some("frostbar.sink"));
