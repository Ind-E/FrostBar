...
#[derive(
    Debug, Clone, Copy, Deserialize, Serialize, Default, Eq, PartialEq, Hash,
)]
pub enum Category {
    #[default]
    ApplicationStatus,
            ...
            .map(|pixmap| {
                ...
                let pixel_values = fields
                    ...
                    .ok_or(Error::InvalidData(
                        "invalid or missing pixel values",
                    ))?
                    .downcast_ref::<&Array>()?;
